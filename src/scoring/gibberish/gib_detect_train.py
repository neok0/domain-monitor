...
class GibberishLearner:
    ...
    def train(self):
        ...
        # bad phrases.
        good_probs = [self.avg_transition_prob(l, counts) for l in open('good.txt')]
        bad_probs = [self.avg_transition_prob(l, counts) for l in open('bad.txt')]
